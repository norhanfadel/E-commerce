                ...
                <div class="product-details"><!--product-details-->
                    <div class="col-sm-5">
                        <div class="view-product">
                            <img src="data:image/jpg;base64,${requestScope.productDetails.imageName}" alt="" width="400" height="400"/>
                        </div>
                    </div>
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
                            ...
                            <span>
                                        <span><c:out value="${requestScope.productDetails.price}"/> LE </span>
                                        <label>Quantity:</label>
                                        <input type="text" id="productQuantity" value="<c:out value="${requestScope.cartQuantity}"/>" />
                                ...
                                <cnour:if test="${!empty sessionScope.userId}" var="userId">
                                    <button type="button" class="btn btn-fefault cart" onclick="updateQuantity(${requestScope.productDetails.productId},${sessionScope.userId})">
                                            ...
                                            <cnour:if test="${sessionScope.role==null}">
                                                    <a href="login.jsp" class="btn btn-fefault cart"><i class="fa fa-shopping-cart"></i>
                                            Add to cart</a>
                                            </cnour:if>
